...
public class V1_11 extends NMSWrapper {
    ...
    public BookshelfState getStoredBookshelfState(ItemStack itemStack, int slots) {
        ...
        if (blockState.hasKey("Items")) {
            NonNullList<net.minecraft.server.v1_11_R1.ItemStack> contents = NonNullList.a(slots, CraftItemStack.asNMSCopy(AIR));
    ...
    public ItemStack withStoredBookshelfState(ItemStack itemStack, BookshelfState bookshelfState) {
        ...
        if (bookshelfState.getContents() != null) {
            NonNullList<net.minecraft.server.v1_11_R1.ItemStack> contents = NonNullList.a();
            for (ItemStack item : bookshelfState.getContents()) {
                contents.add(CraftItemStack.asNMSCopy(itemNonNull(item)));
            }
            ContainerUtil.a(blockState, contents);
        }
        tag.set("BlockEntityTag", blockState);
        merge.set("tag", tag);
        nbt.a(merge);
        net.minecraft.server.v1_11_R1.ItemStack modifiedNmsItemStack = new net.minecraft.server.v1_11_R1.ItemStack(nbt);
