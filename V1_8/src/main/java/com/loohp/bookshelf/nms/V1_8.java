...
public class V1_8 extends NMSWrapper {
    ...
    public BookshelfState getStoredBookshelfState(ItemStack itemStack, int slots) {
        ...
        if (blockState.hasKey("Items")) {
            ...
            for (int i = 0; i < nbttaglist.size(); ++i) {
                ...
                if (j < items.length) {
                    net.minecraft.server.v1_8_R1.ItemStack item = net.minecraft.server.v1_8_R1.ItemStack.createStack(itemNbt);
    ...
    public ItemStack withStoredBookshelfState(ItemStack itemStack, BookshelfState bookshelfState) {
        ...
        merge.set("tag", tag);
        nbt.a(merge);
        net.minecraft.server.v1_8_R1.ItemStack modifiedNmsItemStack = net.minecraft.server.v1_8_R1.ItemStack.createStack(nbt);
    ...
    public void sendBookshelfWindowOpen(Player player, Inventory inventory, Component title) {
        ...
        entityPlayer.playerConnection.sendPacket(new PacketPlayOutOpenWindow(container.windowId, "minecraft:container", ChatSerializer.a(GsonComponentSerializer.gson().serialize(title)), inventory.getSize()));
