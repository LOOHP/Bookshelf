...
public class BookshelfUtils {
    ...
    public static BookshelfState holderState(BookshelfHolder holder) {
        return new BookshelfState(holder.getTitle(), holder.getInventory().getContents());
    }
    ...
    public static Inventory fromBase64(String data, BookshelfHolder holder) throws IOException {
        try {
            ByteArrayInputStream inputStream = new ByteArrayInputStream(Base64Coder.decodeLines(data));
            BukkitObjectInputStream dataInput = new BukkitObjectInputStream(inputStream);
            Inventory inventory = BookshelfManager.createBookshelfInventory(holder, dataInput.readInt() / 9);
