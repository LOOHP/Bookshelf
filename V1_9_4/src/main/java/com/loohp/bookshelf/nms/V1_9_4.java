...
public class V1_9_4 extends NMSWrapper {
    ...
    public BookshelfState getStoredBookshelfState(ItemStack itemStack, int slots) {
        ...
        if (blockState.hasKey("Items")) {
            ...
            for (int i = 0; i < nbttaglist.size(); ++i) {
                ...
                if (j < items.length) {
                    net.minecraft.server.v1_9_R2.ItemStack item = net.minecraft.server.v1_9_R2.ItemStack.createStack(itemNbt);
    ...
    public ItemStack withStoredBookshelfState(ItemStack itemStack, BookshelfState bookshelfState) {
        ...
        merge.set("tag", tag);
        nbt.a(merge);
        net.minecraft.server.v1_9_R2.ItemStack modifiedNmsItemStack = net.minecraft.server.v1_9_R2.ItemStack.createStack(nbt);
